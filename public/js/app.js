...
__webpack_require__(/*! ./components/utils */ "./resources/js/components/utils.js");
...
var showResults = function showResults(data, container) {
...
var showSearchLoader = function showSearchLoader(input) {
...
var hideSearchLoader = function hideSearchLoader(input) {
  var icon = $(input).closest('.input-group').find('i.fa');
...
window.makeRequest = function (url, data) {
  ...
  $.ajax({
    ...
    error: function error(_error) {
      ...
      if (isset(_error.responseText)) {
        result.details = _error.responseText;
      }
...
__webpack_require__(/*! /Laravel_learning/countries/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Laravel_learning/countries/resources/sass/app.scss */"./resources/sass/app.scss");
